...
get_header(); ?>
  ...
  <div class="st-container st-flex content-top st-<?php echo esc_html( $bstone_page_layout ); ?>">
		...
		if ( have_posts() ) : ?>
			...
			<header class="page-header">
				<h1 class="page-title"><?php
					...
					printf( esc_html__( 'Search Results for: %s', 'bstone' ), '<span>' . get_search_query() . '</span>' );
				?></h1>
			</header><!-- .page-header -->
