 ...
 */
class Bstone_Control_Radio_Image extends WP_Customize_Control {
	...
	public function enqueue() {
		$css_uri = BSTONE_THEME_URI . 'inc/customizer/custom-controls/radio-image/';
		$js_uri  = BSTONE_THEME_URI . 'inc/customizer/custom-controls/radio-image/';

		wp_enqueue_script( 'bstone-radio-image', $js_uri . 'radio-image.js', array( 'jquery', 'customize-base' ), BSTONE_THEME_VERSION, true );
		wp_enqueue_style( 'bstone-radio-image', $css_uri . 'radio-image.css', null, BSTONE_THEME_VERSION );
	}
