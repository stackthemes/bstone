		...
		public static function defaults() {
			...
			return apply_filters(
				'bstone_theme_defaults', array(
					...
					'bfbuttons-bg-color'   			=> '#ffffff',
					'bfbuttons-bg-color-hover'   	=> '#ffffff',
					'bfbuttons-text-color'   		=> '#1A3663',
					'bfbuttons-text-color-hover'   	=> '#1A3663',
					'bfbuttons-border-color'   		=> '#e8eaeb',
					'bfbuttons-border-color-hover'  => '#e8eaeb',
